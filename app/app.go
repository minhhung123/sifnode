...
func NewSifApp(
	...
	*/
	...
	transferIBCModule := ibctransferoverride.NewIBCModule(app.TransferKeeper, app.TokenRegistryKeeper, app.BankKeeper, appCodec)
	...
	mockModule := ibcmock.NewIBCModule(&ibcmock.MockIBCApp{}, scopedIBCMockKeeper)
